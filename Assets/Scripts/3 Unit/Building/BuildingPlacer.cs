...
public class BuildingPlacer: MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (isPlacingBuilding) //how I set whether I can drag a marquee in MarqueeSelection.cs. Is there a better way to do this?
        {
            EventManager.TriggerEvent("isPlacingBuilding");
        }
        else
        {
            EventManager.TriggerEvent("isNotPlacingBuilding");
        }
    }
